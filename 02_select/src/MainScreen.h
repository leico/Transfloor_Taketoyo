...
inline void MainScreen :: SceneChange(const int scene){
  ...
  switch( scene ){
    ...
    case  2  : delete basedraw; basedraw = new takami();      break; //EscapeParticles
    case  3  : delete basedraw; basedraw = new SineField();   break; //Sine
    case  4  : delete basedraw; basedraw = new Spratoon();    break; //Spratoon
    case  5  : delete basedraw; basedraw = new AmnbField();   break; //amenbo
    case  6  : delete basedraw; basedraw = new nununu();      break; //Chaser
    case  7  : delete basedraw; basedraw = new Gravity();     break; //Gravity
    case  8  : delete basedraw; basedraw = new dot();         break; //dot
